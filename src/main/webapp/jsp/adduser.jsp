...
<div class="right">
        ...
        <div class="providerAdd">
            ...
            <fm:form id="userForm" action="${pageContext.request.contextPath }/user/addUser.do" method="post" modelAttribute="user" enctype="multipart/form-data">
                ...
                <div>
                    <label >用户角色：</label>
                    <!-- 列出所有的角色分类 -->
					<fm:select path="userRole" items="${roles }"></fm:select>
