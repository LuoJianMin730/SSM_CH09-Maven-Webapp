...
<%@include file="/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>执照：</strong><span><img src="<%=request.getContextPath() %>/${provider.license}" /></span></p>
            <p><strong>正面组织机构：</strong><span><img src="${pageContext.request.contextPath }/${provider.frontCode}" /></span></p>
            <p><strong>反面组织机构：</strong><span><img src="<%=request.getContextPath() %>/${provider.sideCode}" /></span></p>
