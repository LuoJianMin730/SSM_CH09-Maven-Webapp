...
<%@include file="/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照1：</strong><span><img src="<%=request.getContextPath() %>/${user.idPicPath }"></span></p>
            <p><strong>证件照2：</strong><span><img src="<%=request.getContextPath() %>/${user.workPicPath }"></span></p>
