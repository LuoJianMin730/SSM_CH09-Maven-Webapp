...
function deleteBill(obj){
	$.ajax({
		type:"GET",
		url:path+"/bill/deteleSmbmsBill.do",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/bill/viewSmbmsBill/"+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/bill/goModifyBill/"+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
